...
input_dir = "/dtu/p1/johlau/Thesis-Synthex/data/LIDC-IDRI-DRR/"
output_dir =  "/dtu/p1/johlau/Thesis-Synthex/data/LIDC-IDRI-DRR-CROPPED/"
...
for idx, path in tqdm(enumerate(image_paths)):
    ...
    image =   keras.utils.load_img(input_dir + path).rotate(270)
